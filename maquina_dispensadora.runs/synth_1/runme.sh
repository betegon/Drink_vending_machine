...
HD_PWD='/home/betegon/Dropbox/UNIVERSIDAD/MASTER/1_MASTER/1er_CUATRI/ampliacin de sistemas electrnicos/maquina_dispensadora/maquina_dispensadora.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maquina_dispensadora.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maquina_dispensadora.tcl
